...
-- Records of sys_user
-- ----------------------------
INSERT INTO `sys_user` VALUES ('1', 'admin', '1RHFCLt64uOOViCTzgSaww==', '系统管理员', '1', '1', '1', null, null, 'zcool321@sina.com', null, null, null, '时间是最好的老师，但遗憾的是——最后他把所有的学生都弄死了', '2016-06-06 06:06:06', '1');
INSERT INTO `sys_user` VALUES ('2', 'test', 'ldKI9edsQVM=', '后台测试用户', '2', '1', '1', null, null, null, null, null, null, null, '2016-06-06 06:06:06', '1');
INSERT INTO `sys_user` VALUES ('3', 'webtest', 'ldKI9edsQVM=', '前台测试用户', '2', '3', '1', null, null, null, null, null, null, null, '2016-06-06 06:06:06', '1');
...
-- ----------------------------
INSERT INTO `tb_article` VALUES ('1', '1', '内容管理平台', '<p>内容管理平台</p>', '124', '123', '12', '2', '1', '1', '1', '20150529_102007_298104.jpg', null, null, null, '2014-03-05', '系统管理员', '2015-01-29', '2015-01-23', '2015-01-28 17:29:55', '2015-01-28', '1');
...
INSERT INTO `tb_article` VALUES ('112', '2', 'S1线6号线西延 明年年底开通', '<p>&nbsp;&nbsp;S1线预计明年年底将与6号线西延一起开通，同时长安街西延工程预计2017年12月全线通车。未来门头沟也将成为距离中心城区最近、交通最便利的新城。这是门头沟区区长王洪钟今天上午做客北京城市广播“市民对话一把手”栏目时透露的。</p><p>　　<strong>S1线与六号线西延一起开通</strong></p><p>　　提到门头沟区的交通发展，王洪钟表示，S1线现在已经开工建设，将在明年年底和地铁6号线西延一起开通。据介绍，S1线磁悬浮铁路在门头沟设了6个站点，届时从门头沟石门营到苹果园仅需10分钟左右。</p><p>　　另外长安街延长线从去年下半年也已经开工建设，预计将在2017年建成。据介绍，西延工程中还将架设永定河跨河大桥。在S1线和长安街延长线两条交通线建设完成后，门头沟区和市区的交通会更加便捷，这两条线也将与阜石路二期以及莲石路到潭柘寺的108国道、未来即将修建的109高速公路等形成一个总的大交通体系。</p>', '221', '3', '11', '1', '1', '1', '9', '20150525_233451_151572.jpg', null, null, null, '2015-04-20', '中新网', null, null, '2015-02-06 09:18:50', '2015-02-06', '1');
...
INSERT INTO `tb_article` VALUES ('314', '13', '爨底下', '<p>http://www.jflyfox.com/mtg/front/article/330.html</p>', '2', '0', '11', '1', '1', '2', '10', '20150524_165122_812162.jpg', 'http://i1.tietuku.com/35171f11a5ec9c51.jpg', null, null, '2015-05-24', '系统管理员', '', '', '2015-05-24 16:50:26', '2015-05-24 16:50:26', '1');
INSERT INTO `tb_article` VALUES ('315', '13', '永定塔', '<p>http://www.jflyfox.com/mtg/front/article/406.html</p>', '2', '0', '11', '1', '1', '2', '10', '20150524_165116_706479.jpg', 'http://i1.tietuku.com/fab40b501ece3fcf.jpg', null, null, '2015-05-24', '系统管理员', '', '', '2015-05-24 16:50:34', '2015-05-24 16:50:34', '1');
INSERT INTO `tb_article` VALUES ('316', '13', '美丽门城', '<p>#</p>', '1', '0', '11', '1', '1', '2', '10', '20150524_165111_42992.jpg', 'http://i1.tietuku.com/6f139452bedaefed.jpg', null, null, '2015-05-24', '系统管理员', '', '', '2015-05-24 16:50:42', '2015-05-24 16:50:42', '1');
INSERT INTO `tb_article` VALUES ('317', '13', '百花山', '<p>http://www.jflyfox.com/mtg/front/article/329.html</p>', '6', '0', '11', '1', '1', '2', '10', '20150524_165105_854676.jpg', 'http://i1.tietuku.com/3951e9cb262621b6.jpg', null, null, '2015-05-24', '系统管理员', '', '', '2015-05-24 23:36:47', '2015-05-24 23:36:47', '1');
...
INSERT INTO `tb_article` VALUES ('378', '5', '金钱小学', null, '3', '0', '11', '1', '1', '2', '9', '20160117_001411_381494.jpg', null, null, null, '2015-05-26', '系统管理员', null, null, '2015-05-26 13:58:48', '2015-05-26 13:58:48', '1');
...
CREATE TABLE `tb_articlelike` (
  ...
  `create_id` int(11) DEFAULT '0' COMMENT '创建者',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=47 DEFAULT CHARSET=utf8 COMMENT='喜欢的文章';
...
CREATE TABLE `tb_comment` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=241 DEFAULT CHARSET=utf8 COMMENT='评论';
...
CREATE TABLE `tb_pageview` (
  ...
  `create_time` varchar(64) NOT NULL COMMENT '创建时间',
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=66 DEFAULT CHARSET=utf8 COMMENT='访问量统计';
